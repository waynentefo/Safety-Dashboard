...
const EditShe_meetings = () => {
  ...
  const { she_meetingsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: she_meetingsId }))
  }, [she_meetingsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: she_meetingsId, data }))
...
EditShe_meetings.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditShe_meetings
